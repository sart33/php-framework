                ...
                <div class="vg-element vg-full vg-box-shadow">
                    <div class="vg-wrap vg-element vg-half vg-left vg-no-space-top">
                        ...
                        <div class="vg-element vg-full vg-left">
                            <span class="vg-header"><?= !empty($this->translate[$row][0]) ?  $this->translate[$row][0] : '' ?></span>
                        </div>
                            <div class="vg-element vg-full vg-left">
                                <span class="vg-text vg-firm-color5"></span><span class="vg_subheader"><?= !empty($this->translate[$row][1]) ?  $this->translate[$row][1] : '' ?></span>
                            </div>
